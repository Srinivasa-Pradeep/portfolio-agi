...
const affirmations = [
  ...
  "If you enter this world knowing you are loved, everything can be dealt with.",
  "Lies run sprints, but the truth runs marathons.",
  "The greatest education is watching the masters at work.",
  "I’m never totally satisfied. I’m a perfectionist.",
  "Look at the man in the mirror and make a change.",
  ...
  "In the center of your being, you have the answer.",
