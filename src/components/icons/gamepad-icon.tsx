...
const GamepadIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    const start = useCallback(() => {
      ...
      animate(scope.current, { scale: 1.05 }, { duration: 0.2, ease: "easeOut" });

      animate(
        ".gamepad-dpad",
        { x: [0, -0.5, 0.5, -0.5, 0], y: [0, 0.5, -0.5, 0.5, 0] },
    ...
    return (
      ...
      >
        ...
        <motion.line className="gamepad-dot-1" x1="15" x2="15.01" y1="12" y2="12" style={{ transformOrigin: "15px 12px" }} />
        <motion.line className="gamepad-dot-2" x1="18" x2="18.01" y1="10" y2="10" style={{ transformOrigin: "18px 10px" }} />
      </motion.svg>
    );
  },
);
